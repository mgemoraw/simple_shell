...
- <b>Everything you need to know to start coding your own shell</b> concept page
...
# More Info
## Output
- Unless specified otherwise, your program <b>must have the exact same output</b> as `sh (/bin/sh)` as well as the exact same error output.
